        ...
        <div class="row justify-content-center" style="margin-top: 80px;">
            <div class="col-md-8">
                <div class="card glass">
                    ...
                    <div class="card-body" style="margin-left: auto; margin-right: auto;">
                        <a style="width: 170px; height: 40px; font-size: 18px;" class="btn btn-outline-primary" href="{{ route('tutoMemorama') }}" role="button"><i class="fas fa-chalkboard-teacher"></i> ¿Cómo jugar?</a>
                    </div>
